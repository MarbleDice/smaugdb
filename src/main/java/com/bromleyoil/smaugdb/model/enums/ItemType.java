...
public enum ItemType implements Labelable {
	...
	MISSILE_WEAPON, PROJECTILE, QUIVER, SHOVEL, SALVE, COOK, KEYRING, ODOR, CHANCE, PIECE, HOUSEKEY, JOURNAL, JEWELRY,
	GEM, DRINK, JUKEBOX, CLOTHING, WARP_STONE, NPC_CORPSE, PC_CORPSE;
